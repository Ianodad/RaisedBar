...
.then(querySnapshot => {
  ...
  // console.log(data);
    console.log(dayjs(data[0].dateCreated.seconds+data[0].dateCreated.nanoseconds).fromNow())
    console.log(new Date(data[0].dateCreated.seconds * 1000))
    console.log(dayjs(data[0].dateCreated.seconds).format('YYYY-DD-MM'))
