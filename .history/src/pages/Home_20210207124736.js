        ...
        return (
          <Layout>
            <div class="container">
              ...
              <div className="container-fluid yourCollection position-absolute w-100" style={{top:"31%"}}>
                <h2 className="border-bottom col-2 mx-0 px-0" style={{color:"white", fontWeight:"900", fontSize:"2em", borderBottom: '5px'}}>Your Collection</h2>
