    ...
    const renderModalContent = () => {
      if (search) {
        if (!searchData) {
          ...
          return (
            <div className="content d-flex flex-wrap">
              {searchData &&
                searchData.map((item, i) => <Card data={item} key={i} />)}
            </div>
          );
        }
      } else {
        return (
          <div className="content d-flex flex-wrap">
            {cocktails &&
              cocktails.map((cocktail, i) => <Card data={cocktail} key={i} />)}
          </div>
        );
      }
    };
    ...
    return (
      <Layout>
        <div class="container">
          ...
          >
            <div class="container-fluid">
              <div className="modal-header row">
                {renderModalTitle()}
                <button
                  className="float-lg-right col-1"
                  style={{ zIndex: 4 }}
          ...
          <div
            className="search-bar position-absolute container"
            style={{ top: "12%" }}
          >
            <Search onSearch={this.onHandleSearch} />
          </div>
          <div
            className="container-fluid yourCollection position-absolute w-100"
            style={{ top: "31%" }}
          >
            <h2
              className="border-bottom col-2 mx-0 px-0"
              style={{
                color: "white",
                fontWeight: "900",
                fontSize: "2em",
          ...
          >
            ...
            <div
              className="create-cocktail col-md-6 col-lg-6"
              style={{ width: "18em" }}
            >
              <div className="create card col-md-5 float-right mt-4">
                <div
                  className="create-inside flex-column inline-block"
                  style={{ marginTop: "30px" }}
                >
                  <h2>Create your</h2>
                  <h2 style={{ fontSize: "40px", fontWeight: "900px" }}>
                    story
                  </h2>
                  <div className="create-button" style={{ marginTop: "2em" }}>
